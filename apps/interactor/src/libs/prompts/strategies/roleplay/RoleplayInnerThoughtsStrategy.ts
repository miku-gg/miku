  ...
  protected getLabels(): Record<string, Record<string, string>> {
    const labels = {
      en: {
        ...
        just_write_your_thoughts: 'Just write your thoughts directly without any prefix or explanation.',
      ...
      es: {
        ...
        just_write_your_thoughts: 'Simplemente escribe tus pensamientos directamente sin ningún prefijo o explicación.',
      ...
      es_ar: {
        ...
        just_write_your_thoughts: 'Simplemente escribí tus pensamientos directamente sin ningún prefijo o explicación.',
        current_reaction: 'Reacción de %: "',
        current_response: 'Respuesta de %: "',
        inner_thoughts_prompt: 'Pensamientos internos de %: "',
      },
      ...
      fr: {
        ...
        just_write_your_thoughts: 'Écris simplement tes pensées directement sans aucun préfixe ou explication.',
      ...
      de: {
        ...
        just_write_your_thoughts: 'Schreibe einfach deine Gedanken direkt ohne Präfix oder Erklärung.',
      ...
      pt_br: {
        ...
        just_write_your_thoughts: 'Apenas escreva seus pensamentos diretamente sem prefixo ou explicação.',
      ...
      ru: {
        ...
        just_write_your_thoughts: 'Просто напиши свои мысли напрямую без префикса или объяснения.',
      ...
      ja: {
        ...
        just_write_your_thoughts: '接頭辞や説明なしに、思考を直接書いてください。',
