const labels: Record<string, Record<string, string>> = {
  en: {
    ...
    inner_thoughts_instruction: "--- INNER THOUGHTS ---\n%'s Inner thoughts (Valerian's point of view,first person, raw thoughts only, no formatting). This is IMPORTANT: for inner thoughts, you should not describe actions or movements, only feelings, opinions, and mental reactions. Write your thoughts as text only, do not use brackets, parentheses, or any other formatting.",
    character_inner_thoughts: "%'s inner thoughts",
    yes: 'Yes',
    no: 'No',
    angry: 'angry',
    sad: 'sad',
  ...
  es: {
    ...
    inner_thoughts_instruction: '--- PENSAMIENTOS INTERNOS ---\nPensamientos internos de % (punto de vista de Valerian, primera persona, solo pensamientos en bruto, sin formato). Esto es IMPORTANTE: para pensamientos internos, no debes describir acciones o movimientos, solo sentimientos, opiniones y reacciones mentales. Escribe tus pensamientos solo como texto, no uses corchetes, paréntesis o cualquier otro formato.',
    character_inner_thoughts: 'Pensamientos internos de %',
    yes: 'Sí',
    no: 'No',
    angry: 'enfadado',
    sad: 'triste',
  ...
  es_ar: {
    ...
    reaction_instruction: '# Reacción + 2 párrafos, atractivos, naturales, auténticos, descriptivos, creativos.',
    character_reaction: 'Reacción de %',
    inner_thoughts_instruction: '--- PENSAMIENTOS INTERNOS ---\nPensamientos internos de % (punto de vista de Valerian, primera persona, solo pensamientos en bruto, sin formato). Esto es IMPORTANTE: para pensamientos internos, no debés describir acciones o movimientos, solo sentimientos, opiniones y reacciones mentales. Escribí tus pensamientos solo como texto, no uses corchetes, paréntesis o cualquier otro formato.',
    character_inner_thoughts: 'Pensamientos internos de %',
    yes: 'Sí',
    no: 'No',
    angry: 'enojado',
  ...
  pt_br: {
    ...
    inner_thoughts_instruction: '--- PENSAMENTOS INTERNOS ---\nPensamentos internos de % (ponto de vista do Valerian, primeira pessoa, apenas pensamentos brutos, sem formatação). Isso é IMPORTANTE: para pensamentos internos, você não deve descrever ações ou movimentos, apenas sentimentos, opiniões e reações mentais. Escreva seus pensamentos apenas como texto, não use colchetes, parênteses ou qualquer outro formato.',
    character_inner_thoughts: 'Pensamentos internos de %',
    yes: 'Sim',
    no: 'Não',
    angry: 'bravo',
    sad: 'triste',
  ...
  fr: {
    ...
    inner_thoughts_instruction: '--- PENSÉES INTÉRIEURES ---\nPensées intérieures de % (point de vue de Valerian, première personne, pensées brutes uniquement, sans formatage). C\'est IMPORTANT: pour les pensées intérieures, vous ne devez pas décrire d\'actions ou de mouvements, seulement des sentiments, des opinions et des réactions mentales. Écrivez vos pensées uniquement comme du texte, n\'utilisez pas de crochets, de parenthèses ou tout autre formatage.',
    character_inner_thoughts: 'Pensées intérieures de %',
    yes: 'Oui',
    no: 'Non',
    angry: 'en colère',
    sad: 'triste',
  ...
  de: {
    ...
    inner_thoughts_instruction: '--- INNERE GEDANKEN ---\nInnere Gedanken von % (Valerians Sichtweise, erste Person, nur rohe Gedanken, ohne Formatierung). Das ist WICHTIG: für innere Gedanken sollten Sie keine Handlungen oder Bewegungen beschreiben, nur Gefühle, Meinungen und mentale Reaktionen. Schreiben Sie Ihre Gedanken nur als Text, verwenden Sie keine Klammern, Parenthesen oder andere Formatierung.',
    character_inner_thoughts: 'Innere Gedanken von %',
    yes: 'Ja',
    no: 'Nein',
    angry: 'wütend',
    sad: 'traurig',
  ...
  ru: {
    ...
    inner_thoughts_instruction: '--- ВНУТРЕННИЕ МЫСЛИ ---\nВнутренние мысли % (с точки зрения Валериана, от первого лица, только сырые мысли, без форматирования). Это ВАЖНО: для внутренних мыслей вы не должны описывать действия или движения, только чувства, мнения и ментальные реакции. Пишите свои мысли только как текст, не используйте скобки, кавычки или любое другое форматирование.',
    character_inner_thoughts: 'Внутренние мысли %',
    yes: 'Да',
    no: 'Нет',
    angry: 'злой',
    sad: 'грустный',
  ...
  jp: {
    ...
    inner_thoughts_instruction: '--- 内面の思考 ---\n%の内面の思考（ヴァレリアンの視点、一人称、生の思考のみ、フォーマットなし）。これは重要です：内面の思考では、行動や動きを描写せず、感情、意見、精神的反応のみを描写してください。思考はテキストとしてのみ書いてください。括弧、引用符、その他のフォーマットは使用しないでください。',
    character_inner_thoughts: '%の内面の思考',
    yes: 'はい',
    no: 'いいえ',
    angry: '怒っている',
    sad: '悲しい',
