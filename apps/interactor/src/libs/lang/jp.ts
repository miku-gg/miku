...
export const LANGUAGE_JP: i18nConfig = {
  ...
  SCENE_SELECTOR_CREATE_SCENE: 'シーンを作成',
  SCENE_SELECTOR_CHANGE_SCENE: 'シーンを変更',
  SCENE_SELECTOR_GENERATE_SCENE: 'シーンを生成',
  SCENE_SELECTOR_CREATE_NEW_SCENE: '新しいシーンを作成',

  SCENE_SUGGESTION_GENERATE_NEXT_SCENE: '次のシーンを生成',
  SCENE_SUGGESTION_GO_TO_NEXT_SCENE: '次のシーンに進む',

  SCENE_SUGGESTIONS_MODAL: 'シーンの提案',
  SCENE_SUGGESTIONS_MODAL_SCENE_GENERATIONS_LEFT:
    '今日の残りのシーン生成回数。',
  SCENE_SUGGESTIONS_MODAL_DESCRIBE_SCENE: 'シーンを説明する',
