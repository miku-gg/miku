...
export type i18nKey =
  ...
  | 'SCENE_SELECTOR_CREATE_SCENE'
  | 'SCENE_SELECTOR_CHANGE_SCENE'
  | 'SCENE_SELECTOR_GENERATE_SCENE'
  | 'SCENE_SELECTOR_CREATE_NEW_SCENE'
  | 'SCENE_SUGGESTION_GENERATE_NEXT_SCENE'
  | 'SCENE_SUGGESTION_GO_TO_NEXT_SCENE'
  | 'SCENE_SUGGESTIONS_MODAL'
  | 'SCENE_SUGGESTIONS_MODAL_SCENE_GENERATIONS_LEFT'
  | 'SCENE_SUGGESTIONS_MODAL_DESCRIBE_SCENE'
  | 'SCENE_SUGGESTIONS_MODAL_SUGGEST_SCENES_BUTTON'
  | 'SCENE_SUGGESTIONS_MODAL_GENERATING_SCENE'
  | 'SCENE_SUGGESTIONS_MODAL_FETCHING_SUGGESTIONS'
  | 'CREATE_SCENE_SCENE_PROMPT'
  | 'CREATE_SCENE_SCENE_TITLE'
