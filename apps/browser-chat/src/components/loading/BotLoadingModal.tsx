          ...
          <div className="border-0 rounded-lg shadow-2xl relative flex flex-col w-full bg-gray-900 outline-none focus:outline-none p-10 items-center">
            ...
            <div className="flex flex-row justify-between gap-6 max-[450px]:flex-wrap">
              ...
              >
                ...
                <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">Miku</h5>
                <span className="text-sm text-gray-500 dark:text-gray-100 bg-green-600 py-1 px-2 mt-4 rounded-lg">Open AI</span>
              </button>
              <button
              ...
              >
                ...
                <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">Elaina</h5>
                <span className="text-sm text-gray-500 dark:text-gray-100 bg-blue-600 py-1 px-2 mt-4 rounded-lg">Pygmalion</span>
              </button>
            </div>
            {IS_ALPHA_LIVE ? (
      ...
      <div className="flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-black bg-opacity-50 backdrop-blur-sm">
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          <div className="border-0 rounded-lg shadow-2xl relative flex flex-col w-full bg-gray-100 outline-none focus:outline-none p-10">
            <div role="status">
              <svg aria-hidden="true" className="inline w-20 h-20 mr-2 text-gray-200 animate-spin dark:text-violet-200 fill-violet-800" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
