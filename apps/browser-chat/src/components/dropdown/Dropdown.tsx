...
export const DropDown = ({
  ...
  return (
    <Menu
      as="div"
      className="flex flex-col-reverse text-left relative min-w-[150px]"
    >
      ...
      >
        {/* <Menu.Items className="text-white rounded-md absolute top-12 z-10 w-full"> */}
        <Menu.Items
          className={`${
            top ? "top-12" : "bottom-12"
          } text-white rounded-md absolute z-10 w-full`}
        >
              ...
              <Menu.Item key={`item-${item}-${index}`}>
                <button
                  className={classNames(
                    selectedIndex === index ? "bg-violet-800" : "",
