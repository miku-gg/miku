...
import { hasTextStop, parsePygmalionResponse } from './PygmalionPromptCompleter';
type LLaMAPropTypes = InferProps<typeof LLaMAServicePropTypes>;

export interface LLaMAParams extends Core.ChatPromptCompleters.ChatPromptCompleterConfig {
  serviceEndpoint: string;
  props: LLaMAPropTypes;
  signer: Core.Services.ServiceQuerySigner
}

export class LLaMAPromptCompleter extends Core.ChatPromptCompleters.ChatPromptCompleter {
